        ...
        <TableBody>
          {results.map((result, index) => (
            <TableRow key={index}>
              ...
              <TableCell className="border border-gray-200 text-center p-1 text-sm sm:text-base md:text-lg">{result.first_round}</TableCell>
              <TableCell className="border border-gray-200 text-center p-1 text-sm sm:text-base md:text-lg">{result.second_round}</TableCell>
